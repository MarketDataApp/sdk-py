...
if [ "$ENV" = "test" ]; then
    ...
    URL="https://test.pypi.org/project/marketdata-sdk"
elif [ "$ENV" = "prod" ]; then
    ...
    read -p "Press Enter to continue or Ctrl+C to cancel..."
    REPOSITORY=""
    URL="https://pypi.org/project/marketdata-sdk"
else
...
echo "  pip install --index-url https://test.pypi.org/simple/ marketdata-sdk"
echo ""
echo "To install from PyPI:"
echo "  pip install marketdata-sdk"
